...
const Nav = () => {
  ...
  return (
    <div className="w-screen h-auto  flex items-center justify-center flex-col  fixed top-0 z-50">
      <div className="w-full h-[4.5rem] bg-white flex items-center justify-center border-b-[1.2px]">
        <div className="w-[90vw] mx-auto flex items-center justify-between">
          <div
            onClick={handleMenu}
            className=" xs:block lg:hidden mr-3 cursor-pointer"
          >
            {menuOpen ? (
              <svg
                viewBox="0 0 512 512"
