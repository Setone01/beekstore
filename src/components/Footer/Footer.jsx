  ...
  return (
    <div className="w-screen max-h-max bg-slate-900 pt-8 pb-4 mt-auto">
      <div className="w-[90%] mx-auto flex justify-center items-center flex-col">
        <div className="w-full flex justify-between flex-wrap gap-8 mb-3">
          <div className="xs:w-full md:w-3/10">
            <Link>
          ...
          <div className="w-2/10">
            <h4 className=" xs:text-[16px] max-w-max lg:text-lg text-white border-b-[2.8px] pb-0.5 font-bold mb-1">
              Help & Support
            </h4>
          ...
          <div className="flex flex-col justify-start xs:w-full md:w-3/10">
            <h4 className="xs:text-[16px] lg:text-lg text-white font-bold border-b-[2.8px] pb-0.5 max-w-max capitalize mb-1">
              Newsletter
            </h4>
            ...
            {/* <form className="w-full flex justify-start max-w-md mx-auto">
