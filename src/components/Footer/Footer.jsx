...
const Footer = () => {
  return (
    <div className="w-screen max-h-max bg-slate-200 pt-8 pb-4 mt-auto">
      <div className="w-[90%] mx-auto flex justify-center items-center flex-col">
        <div className="flex w-full justify-between gap-8">
          <div className="xs:w-full md:w-[100rem]">
            <Link>
              <h3 className=" text-slate-900 text-[23px] font-bold mb-4">
                Beekstore
              </h3>
            </Link>
            ...
            <div className="flex mt-5 items-center">
              <a href="#" className=" text-slate-900 hover:text-gray-500">
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
              ...
              <a href="#" className="text-slate-900 hover:text-gray-500 ms-5">
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="w-full">
            <h4 className=" text-lg text-slate-900 font-bold capitalize mb-1">
              Contact us
            </h4>
            <ul>
              <li className="text-[14px] flex items-center font-medium hover:underline text-slate-900 mb-2.5">
                <span className="mr-2">
                  <svg
                    viewBox="0 0 512 512"
                    fill="currentColor"
              ...
              <li className="flex items-center text-[14px] font-medium hover:underline text-slate-900 mb-2.5">
                <span className="mr-2">
                  <svg
                    viewBox="0 0 512 512"
                    fill="currentColor"
              ...
              <li>
                <Link
                  to="mailto:pepstore"
                  className="text-[14px] flex items-center font-medium hover:underline text-slate-900 pb- "
                >
                  <span className="mr-2">
                    <svg
          ...
          <div className="w-full">
            <h4 className="text-lg text-slate-900 font-bold mb-1">
              Help & Support
            </h4>
            <ul>
              {footerLink.map((item) => (
                <li key={item.id}>
                  <Link
                    className="text-[14px] font-medium hover:underline text-slate-900 "
                    to={item.path}
                  >
                    {item.title}
                  </Link>
          ...
          <div className=" xs:w-full md:w-[100rem]">
            <h4 className="text-lg text-slate-900 font-bold capitalize mb-3">
              newsletter
            </h4>
            <p className="font-medium text-[14px] text-slate-900 mb-4">
            ...
            <form className="w-full max-w-md mx-auto">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  id="default-email"
                  className="block w-full p-3 ps-10 text-sm font-medium text-gray-900 border border-gray-300 rounded-md bg-white focus:ring-[1px] focus:border-slate-900/40 outline-0 focus:outline-none"
                  placeholder="Enter your email here..."
                  required
                />
                <button
                  type="submit"
                  className="text-white font-medium absolute end-2.5 bottom-[5px] bg-slate-900 focus:bg-slate-900/70 focus:ring-1 focus:outline-none rounded-md text-sm px-4 py-2"
                >
                  <svg
                    fill="currentColor"
                    viewBox="0 0 16 16"
        ...
        <div className=" w-full h-[1px] bg-gray-700 text-gray-500 my-6"></div>
